...
/**
 * Final call-to-action section with email + social links.
 */
export function CTA() {
      ...
      <div className={styles.inner}>
        ...
        <div ref={textRef} className="reveal">
          ...
          <p className={styles.description}>
            Whether it&apos;s an AI system, a backend architecture, or something that
            doesn&apos;t exist yet — I&apos;d love to talk about it.
          </p>
        </div>
